...
/*
 ...
 종료시 Friend타입의 객체배열에 저장된 친구의 정보를 파일의 형태로 저장할
 수 있도록 직렬화 하시오.
...
class FriendInfoHandler implements Serializable {
	...
	//친구정보를 파일형태로 저장하기
	public void saveFreindInfo() {
		
		try {
			ObjectOutputStream out = new ObjectOutputStream(
					new FileOutputStream("src/ex20io/freind_info.obj"));
			//myFreinds객체배열에 저장된 친구의 정보만크 반복
